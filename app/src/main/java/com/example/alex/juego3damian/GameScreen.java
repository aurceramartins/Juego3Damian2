...
public class GameScreen extends GLScreen {
    ...
    public GameScreen(Game game) {
        ...
        worldListener = new World.WorldListener() {
            ...
            @Override
            public void hit() {
                Assets.playSound(Assets.petadaSound);
            }

            @Override
            public void heart() {
                Assets.playSound(Assets.heartSound);
    ...
    private void updateRunning(float deltaTime) {
        ...
        if (world.state == World.WORLD_STATE_GAME_OVER) {
            ...
            if (lastScore >= Settings.highScores[4]) {
                ...
                scoreString = "Puntuacion: " + lastScore;
            }
    ...
    private void presentLevelEnd() {
        String topText = "La entrada al mundo real esta ...";
        String bottomText = "En otra puerta infernal!";
        float topWidth = Assets.font.glyphWidth * topText.length();
        float bottomWidth = Assets.font.glyphWidth * bottomText.length();
        Assets.font.drawText(batcher, topText, 128 - topWidth / 2, 480 - 40);
    ...
    private void presentGameOver() {
        ...
        Assets.font.drawText(batcher, scoreString, 128 - scoreWidth / 2, 480 - 20);
    }
